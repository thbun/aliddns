...
public class DDNS {
    ...
    public static void setddsn(String[] args) {
        // 设置鉴权参数，初始化客户端
        DefaultProfile profile = DefaultProfile.getProfile(
                "cn-qingdao",// 地域ID
                "xxxxxxxxx",// 您的AccessKey ID
                "xxxxxxxx");// 您的AccessKey Secret
        ...
        // 主域名
        describeDomainRecordsRequest.setDomainName("xxxxxxxxxx");
        // 主机记录
